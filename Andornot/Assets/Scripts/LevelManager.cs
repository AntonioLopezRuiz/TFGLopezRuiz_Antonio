...
public class LevelManager : MonoBehaviour
{
    ...
    public void Test()
    {
        ...
        OutPoint ouputF = input1.GetComponentInChildren<OutPoint>();
        ouputF.value = 0;

        OutPoint ouputF2 = input2.GetComponentInChildren<OutPoint>();
        ouputF2.value = 1;
    ...
    public void Clear()
    {
        for (int i = 0; i < elements_parent.childCount; i++)
        {
            Debug.Log("X: " + elements_parent.GetChild(i).gameObject.transform.position.x + " Y:" + elements_parent.GetChild(i).gameObject.transform.position.y + " Z: " + elements_parent.GetChild(i).gameObject.transform.position.z);
    ...
    public GameObject Spawn(int type, bool FIXBUGUNITYSUKA)
    {
        ...
        switch (type)
        {
            ...
            case 12:
                ...
                break;
            case 13:
                go = Instantiate(input1, elements_parent);
                break;
            case 14:
                go = Instantiate(input2, elements_parent);
                break;
            case 15:
                go = Instantiate(output, elements_parent);
                break;
            default:
                go = Instantiate(EditableOut, elements_parent);
                break;
